# Shoping Cart saucedemo
Es un robot de pruebas End to End para la página web https://www.saucedemo.com

El robot se construye utilizando Intellij Community, el lenguaje de programación Java y gradle como gestor de dependencias y compilador del proyecto.
...
Se usa ChromeDriver como driver de conectividad con la web y se complementa con Serenity para lograr la conectividad entre la automatización y Google Chrome. Se utiliza Selenium para realizar la adherencia con la página web.
...
SerenityBdd 3.2.3
Cucumber 3.2.3
ChromeDriver Versión compatible con el build de Google Chrome
Git 2.35.1.2 
Sonar 9.4.0.54424
```
------------------------------------------------------
...
3. Instalar [Google Chrome](https://www.google.fr/chrome/?brand=YTUH&gclid=Cj0KCQjwjbyYBhCdARIsAArC6LLrP-hl44UW1idgp4LjhGDbqytW2lTb66cBeYX9huBnHiLbrJsXmFsaAjHgEALw_wcB&gclsrc=aw.ds)
4. La máquina donde se ejecute debe tener acceso a los respositorios de mavencentral y gradle
...
sonarqube {
    properties {
        ...
        property "sonar.name", "appGateMobile"
        property "sonar.host.url", "http://localhost:9000"
        property "sonar.java.binaries", "src/main/java"
        property "sonar.exclusions", "**/*.gradle, **/*.yml"
    }
}
```
